...
const posts: Blog[] = [
  ...
  },
  {
    ...
    imageUrl:
      'https://res.cloudinary.com/dpbuspblx/image/upload/v1679958907/cla-cta/Sermon_Quote_2_Twitter_iotdpu.png',
    date: 'May 12, 2020',
    datetime: '2020-05-12',
    author: {
      name: 'Julia Thomas',
      imageUrl:
        'https://images.unsplash.com/photo-1566053618601-6c0b8bb10c15?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80',
    },
  },
  {
    id: 3,
    ...
    imageUrl:
      'https://res.cloudinary.com/dpbuspblx/image/upload/v1679958908/cla-cta/Sunday_Service_IG_cprhra.png',
    date: 'Aug 22, 2020',
    datetime: '2020-08-22',
    author: {
      name: 'John Smith',
      imageUrl:
        'https://images.unsplash.com/photo-1585952034126-3aa3ea3a27d9?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80',
    },
  },
]
