"use client"
import { CalendarIcon, ChatBubbleLeftIcon, ChatBubbleLeftRightIcon, DocumentIcon } from '@heroicons/react/20/solid'
        ...
        <div className="flex h-full w-full items-end">
          <div className='w-full'>
            ...
            <div className="flex justify-between w-full items-center">
              ...
              <div className='flex text-sm items-center mr-2'><DocumentIcon className='h-6 mr-1'/><span className="whitespace-nowrap">category</span></div>
              <div className='flex text-sm items-center'><ChatBubbleLeftIcon className='h-6 mr-1'/><span className="whitespace-nowrap">Comments</span></div>
            </div>
          </div>
        </div>
      </div>
