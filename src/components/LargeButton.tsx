  ...
  return (
    <button
      className={clsx(
        ...
        "transition-all inline-flex items-center justify-center whitespace-nowrap rounded-md border border-transparent h-12 px-7 lg:px-14 text-base font-medium shadow-sm hover:bg-primary-dark"
      )}
    >
      {children}
    </button>
