  ...
  return (
    <header className="bg-background fixed w-full z-50">
      <Popover className="relative">
        <div className="mx-auto flex max-w-7xl items-center p-2 md:p-6 md:justify-start justify-between md:space-x-10 lg:px-8">
          ...
          <div className="-my-2 -mr-2 md:hidden">
            <Popover.Button className="inline-flex items-center justify-center rounded-md bg-white p-2 mr-8 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
