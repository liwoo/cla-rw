...
const address = ['Address Line 1', 'Address Line 2']
          ...
          <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <div className="mt-10 md:mt-0">
                <h3 className="mb-6 text-sm font-semibold leading-6 text-gray-300">
                  Contact Us
                </h3>
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <div className="mt-6 flex w-full flex-col space-y-4 md:flex-row md:space-y-0 md:space-x-4">
                  {social.map((item) => (
                    <a
                      key={item.name}
                      href={item.href}
                      className="flex space-x-2 text-gray-200 hover:text-gray-400"
                    >
