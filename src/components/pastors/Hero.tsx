...
const Hero = () => {
  ...
  return (
    <div className="relative min-h-[550px] w-full flex items-end">
      <ClientImage
        fill
        quality={50}
        blurDataURL={blurImg}
      ...
      <Container className="relative flex p-8 w-full">
        <div className="text-white">
          <div className="text-3xl font-bold uppercase">Pastor name</div>
          <div className="my-2 text-2xl">Office</div>
          <div>icons</div>
        </div>
      </Container>
    </div>
